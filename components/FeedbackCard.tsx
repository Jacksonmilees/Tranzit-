...
const FeedbackCard: React.FC<FeedbackProps> = ({ content, title, name, img }) => (
  <div className="flex justify-between flex-col px-10 py-12 rounded-[20px] max-w-[370px] md:mr-10 sm:mr-5 mr-0 feedback-card cursor-pointer">
    <Image
      ...
      height={27}
    />
    <p className="font-poppins font-normal text-[18px] leading-[32px] text-gray-600 my-10">
      {content}
    </p>
    <div className="flex flex-row">
      ...
      <div className="flex flex-col ml-4">
        <h4 className="font-poppins font-semibold text-[20px] leading-[32px] text-tranzitBlue">
          {name}
        </h4>
